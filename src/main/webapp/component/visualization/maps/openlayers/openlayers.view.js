...
export var OpenlayersMapViewReact = function (_a) {
    ...
    var _d = React.useContext(LayoutContext), getValue = _d.getValue, setValue = _d.setValue;
    React.useEffect(function () {
        var defaultLayers = user.get('user>preferences>mapLayers').toJSON();
        var layerSettings = getValue(OPENLAYERS_MAP_LAYERS, defaultLayers);
        ...
        listenTo(layerCollection, 'add remove', function () {
            return setValue(OPENLAYERS_MAP_LAYERS, layerCollection.toJSON());
        });
